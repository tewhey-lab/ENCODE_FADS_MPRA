...
perl ${INSTALL_PATH}/MPRA_Oligo-Tag_pipeline/scripts/fq2RCfa.pl ${ID}.merged.extendedFrags.fastq > ${ID}.merged.rc.fasta
perl ${INSTALL_PATH}/MPRA_Oligo-Tag_pipeline/scripts/matchadapter.pl ${ID}.merged.rc.fasta ${ID}.merged.rc
...
perl ${INSTALL_PATH}/MPRA_Oligo-Tag_pipeline/scripts/parse_map.pl ${ID}.merged.rc.match.enh.mapped.barcode.ct > ${ID}.merged.rc.match.enh.mapped.barcode.ct.parsed
Rscript --vanilla ${INSTALL_PATH}/MPRA_Oligo-Tag_pipeline/scripts/plot_barcode_stats.r $ID $REF
